...
for index in range(len(providers)):   
       DNS_dictionary[providers[index]] = ips[index]
...
for key, value in DNS_dictionary.items():
       dictionaries = {}
       # print("provider_name" + " " + key + " primary_server " +  value)
       dictionaries['provider_name'] = key
       dictionaries['primary_server'] = value
       DNS_dictionaries.append(dictionaries)

print("DNS Dictionaries: ")
print(DNS_dictionaries)
print("")
for index in range(len(DNS_dictionaries)):
    print(DNS_dictionaries[index])
    print("--------")
